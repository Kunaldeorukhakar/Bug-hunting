...
trufflehog github --org=$target --results=verified | anew gitsecrets |tee -a newgitsecrets_$(date +"%Y%m%d_%H%M%S").txt | notify -pc ~/Documents/BugBounty/$pc | tee -a gitsecrets.txt
